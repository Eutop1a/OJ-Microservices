...
// @Success 200 {object} _ResponseUsername "令牌有效，返回用户名"
// @Failure 403 {object} _ResponseMsg "无效令牌"
// @Router /open [get]
...
// @Success 200 {object} _ResponseMsg "用户名不存在"
// @Failure 403 {object} _ResponseMsg "Token 已超时或用户名已存在"
// @Router /check [post]
