...
// GetProblemsList 获取问题列表
// @Summary 获取问题列表
// @Description 获取所有问题的列表
// @Accept json
// @Produce json
// @Param username formData string true "要获取问题列表的用户名"
// @Success 200 {object} _ResponseProblems "成功获取问题列表"
// @Failure 403 {object} _ResponseMsg "Token 已超时"
// @Failure 500 {object} _ResponseMsg "获取问题列表出错"
// @Router /list [post]
...
// @Success 200 {object} _ResponseAddProblems "成功添加问题"
// @Failure 403 {object} _ResponseMsg "Token 已超时或用户非管理员"
// @Failure 403 {object} _ResponseMsg "解析表单数据出错"
...
// @Success 200 {object} _ResponseQuestionDetail  "成功获取问题详情"
// @Failure 403 {object} _ResponseMsg "Token 已超时"
// @Failure 403 {object} _ResponseMsg "获取问题详情出错"
