...
// @Success 200 {object} _ResponseAddScore "增加分数成功，返回消息和新的总分数"
// @Failure 403 {string} _ResponseMsg  "Token 已超时"
// @Failure 500 {object} _ResponseError "数据库查询或保存出错"
// @Router /changeScore [post]
func AddScoreToUser(c *gin.Context) {
...
// @Success 200 {object} _ResponseSort "成功获取并排序用户列表"
// @Failure 403 {object} _ResponseMsg "Token 已超时"
// @Failure 500 {object} _ResponseError "数据库查询错误"
